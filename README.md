...
Using QuantumChem-200K, we fine-tune the open-source Qwen-2.5-32B large language model to create a chemistry AI assistant capable of forward property prediction from SMILES. It demonstrates that domain-specific fine-tuning significantly improves prediction accuracy over baselines such as GPT-4o, Llama-3.1-70B, and the base Qwen2.5- 32B model.

[wmae_contribution_4models_rank_log.pdf](https://github.com/user-attachments/files/23843074/wmae_contribution_4models_rank_log.pdf)
